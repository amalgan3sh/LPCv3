        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Branded Products</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-body p-0">
                <form method="post" action="<?php echo site_url('index.php/Usercontroller/supplierAddBrandedProduct'); ?>" enctype="multipart/form-data">
                        ...
                        <div class="bs-stepper-content">
                            ...
                            <div id="information-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="comments" name="comments" placeholder="Enter Comments" required></textarea>
                                </div>
                                <div class="form-group">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url('assets/third_party_products/' . $product->sample_photo); ?>" class="btn btn-info btn-sm" target="_blank">View Photo</a></td>
