  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Third Party Manufactured Products</h1>
          </div>
          <div class="col-sm-6">
    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-body p-0">
                <form method="post" action="<?php echo site_url('index.php/Usercontroller/userAddInquiryThirdPartyProducts'); ?>" enctype="multipart/form-data">
