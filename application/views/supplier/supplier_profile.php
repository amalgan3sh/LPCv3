                    ...
                    <div class="post">
                      ...
                      <?php if (!empty($user_documents) && isset($user_documents[0])): ?>
                          ...
                          <?php if($user_documents[0]['drug_license'] != null) {
                              ...
                              if($id_extension == 'pdf') { 
                                ...
                                <div class="col-sm-3">
                                  <p class="mt-3">
                                      <a href="<?php echo base_url('assets/KYC_Documents/'.$user_documents[0]['drug_license']) ?>" target="_blank">  <i class="fas fa-file-pdf mt-3" style="font-size: 100px;"></i><br></a>
                                      <?php  echo $pdf_doc_name[2]; ?>
                                  </p>
                                </div>
                          <?php } else { ?> 
                          ...
                          <?php  if($user_documents[0]['gmp_certificate'] != null) {
                              $doc_details = explode('.', $user_documents[0]['gmp_certificate']);
                              $id_extension = end($doc_details); 
                              if($id_extension == 'pdf') { 
                                  $pdf_doc_name = explode('_',$user_documents[0]['gmp_certificate'],3);  ?>
                                <div class="col-sm-3">
                                  <p class="mt-3">
                                      <a href="<?php echo base_url('assets/KYC_Documents/'.$user_documents[0]['gmp_certificate']) ?>" target="_blank">  <i class="fas fa-file-pdf mt-3" style="font-size: 100px;"></i><br></a>
                                      <?php  echo $pdf_doc_name[2]; ?>
                                  </p>
                                </div>
                          <?php } else { ?> 
                                <div class="col-sm-4">
                                    <img class="img-fluid mb-3" src="<?php echo base_url('assets/KYC_Documents/'.$user_documents[0]['gmp_certificate']) ?>" alt="Photo">
                                </div>
                          <?php } 
                          }?>
                      ...
                      <?php else: ?>
                        <div class="alert alert-warning" role="alert">
                          <a href="<?php echo site_url('Usercontroller/SupplierKYCRegistration'); ?>" class="alert-link">
