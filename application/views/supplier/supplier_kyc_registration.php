        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="<?php echo base_url('index.php/Usercontroller/supplierKYCUploadDocuments') ?>"  enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                  <label for="exampleInputFile">Drug Licence</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input"  id="drugLicence" name="drug_license" required>
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">GMP Certificate</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="gmp_certificate" name="gmp_certificate" required>
                        <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                      </div>
                      <div class="input-group-append">
                        <span class="input-group-text">Upload</span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-file">
                        <input type="text" class="form-control" id="tax_details" name="tax_details"  value="" placeholder="Enter VAT">
                      </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="national_id_proof" name="national_id_proof">
                        <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                      </div>
                      <div class="input-group-append">
                        <span class="input-group-text">Upload</span>
            ...
            <div class="col-md-4">
                    ...
                    $gmp_certificate_progress = isset($kyc_registration['gmp_certificate']) ? ($kyc_registration['gmp_certificate'] == 1 ? 100 : 20) : 0;
                    ...
                    <div class="progress-group">
                     GMP Certificate
                      <span class="float-right"><b><?= $gmp_certificate_progress ?></b>/100</span>
                      <div class="progress progress-sm">
                        <div class="progress-bar bg-primary" style="width: <?= $gmp_certificate_progress ?> %"></div>
                      </div>
                    </div>
                    <!-- /.progress-group -->
