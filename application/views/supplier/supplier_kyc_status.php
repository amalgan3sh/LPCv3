              ...
              <div class="row">
                ...
                <?php  if($user_documents[0]['gmp_certificate'] != null)
                         ...
                         if($id_extension == 'pdf') { 
                          ...
                          <div class=" mb-2 ">
                         <p class="mt-3"><a href="<?php echo base_url('assets/KYC_Documents/'.$user_documents[0]['gmp_certificate']) ?>" target="_blank">  <i class="fas fa-file-pdf mt-3" style="font-size: 100px;"></i><br></a><?php  echo $pdf_doc_name[2]; ?></p>

                         <?php } else { ?>
                          <div class="col-sm-3">
                  
                  <div class=" mb-2 ">
                          <img class="img-fluid" src="<?php echo base_url('assets/KYC_Documents/'.$user_documents[0]['gmp_certificate']) ?>" alt="Dist Photo 1">
