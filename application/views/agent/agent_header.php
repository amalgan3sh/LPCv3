...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo base_url('index.php/Usercontroller/agentHome') ?>" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
        <a href="<?php echo base_url('index.php/Usercontroller/agentProfile') ?>" class="d-block"><?php echo ($user_data['firstname'].' '.$user_data['lastname']) ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('index.php/Usercontroller/agentHome') ?>" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('index.php/Usercontroller/agentProfile') ?>" class="nav-link">
