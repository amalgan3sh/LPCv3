...
<head>
  ...
  <title>LPC Admin | Dashboard</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url('index.php/Admincontroller/adminDashboard')?>" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo base_url('index.php/Admincontroller/adminDashboard')?>" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?php echo ($user_data['firstname'].' '.$user_data['lastname']) ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('index.php/Admincontroller/adminDashboard')?>" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('index.php/Admincontroller/adminProfile')?>" class="nav-link">
        ...
        <p>Pharmacopeia</p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('index.php/Admincontroller/addInvestProducts')?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Invest Products</p>
                </a>
              </li>
            </ul>
          </li>
