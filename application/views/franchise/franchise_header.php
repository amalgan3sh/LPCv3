...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo base_url('index.php/Usercontroller/franchiseHome') ?>" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
        <a href="<?php echo base_url('index.php/Usercontroller/franchiseProfile') ?>" class="d-block"><?php echo ($user_data['firstname'].' '.$user_data['lastname']) ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('index.php/Usercontroller/franchiseHome') ?>" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('index.php/Usercontroller/franchiseProfile') ?>" class="nav-link">
    ...
    <style>
      ...
      <li class="nav-item">
        ...
        <ul class="nav nav-treeview">
          <li class="nav-item">
            <a href="<?php echo base_url('index.php/Usercontroller/FranchiseKYCRegistration')?>" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Upload Documents</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url('index.php/Usercontroller/franchiseKycStatus')?>" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>KYC Status</p>
            </a>
          </li>
